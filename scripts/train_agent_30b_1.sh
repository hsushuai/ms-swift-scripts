...
# This script is used to train the Qwen3-30B-A3B model with specific configurations.
...
# Usage: bash scripts/train_agent_30b_1.sh > logs/train_agent_30b_1.log 2>&1 &

# arguments
PER_DEVICE_TRAIN_BATCH_SIZE=1
GRADIENT_ACCUMULATION_STEPS=30
DATA_VERSION=6-1
BASE_OUTPUT_DIR="/data01/xushuai/code/output/new_agent/new_agent_30b_v${DATA_VERSION}"
