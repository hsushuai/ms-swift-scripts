...
def parse_args():
    ...
    parser.add_argument("--model", type=str, default="/data1/xushuai/code/output/general/general_batch_24_acc_4_v1", help="Path to the model.")
    parser.add_argument("--test-data", type=str, default="/home/xushuai/code/data/general-raw/extract_params_test.jsonl", help="Path to the test data.")
...
def main(args):
    ...
    llm = LLM(model=model_path, trust_remote_code=True, max_model_len=2048, tensor_parallel_size=2)
